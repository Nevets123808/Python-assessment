...
def one(input1, input2):
	if len(input1) == len(input2): return f"{input1} {input2}"
...
def two(arg1):
	string = ''
	if arg1%3==0: string += 'fizz'
	if arg1%5==0: string += 'buzz'
...
def three(input):
	vowels =['a','e','i','o','u']
	reduc = [letter for letter in input.lower() if letter in vowels]
	return len(reduc)
...
def six(string, int_, char):
	...
	if int_> len(string): return False
	else: return string[int_-1]==char
